	...
	<div class="col-sm-6">
		...
		<div class="panel panel-white">
		    <div class="panel-heading panel-green border-light">
				<h4 class="panel-title">Add Fee Heads</h4>
			...
			<div class="panel-body">
			    <form action="<?php echo base_url();?>configure/saveFeeheads"  method ="post">
			    <div class="col-md-12">
					<div class="row">
						<div class="col-md-7">
							<div class="form-group">
								<label class="control-label">Fee Head</label>
								<input type="text" name="feehaeds" required="true"/>
							</div>
						</div>
						<div class="col-md-5">
							<div class="form-group">
								<button class="btn btn-default">Add FeeHead</button>
							</div>
						</div>
					</div>
                </div>
	...
	<div class="col-sm-6">
		...
		<div class="panel panel-white">
		    <div class="panel-heading panel-yellow border-light">
				<h4 class="panel-title">Fee Head List</h4>
				<div class="panel-tools">										
        			<div class="dropdown">
        				<a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey"><i class="fa fa-cog"></i></a>
        				<ul class="dropdown-menu dropdown-light pull-right" role="menu">
