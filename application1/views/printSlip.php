                	...
                	<div id="page-wrap" style="background-color: white;">
                	    ...
                	    <h3 align="center">Student Detail</h3>
                				...
                				<div style="width: 115px; height: 120px; border: 1px solid #ccc;">
                			        <img alt="<?= $stuInfo->name; ?>" height="115" width="110" src="<?= base_url(); ?>assets/images/stuImage/<?= $stuInfo->student_image; ?>" />
                			    </div>
                				</td>
                			</tr>
                		...
                		<table>
                		    <tr>
                		        <th>नोट:- यह फॉर्म केवल  72 घंटे के लिए मान्य है| अत: आप 72 घंटे के भीतर फीस, फीस काउंटर पे जमा करे |</th>
                		    </tr>
