           	...
           	<div class="col-md-12"> 
            	<div class="col-md-6">
            		...
            		<div class="form-group">
            			...
            			<input type="text" style="margin-left: 135px;" value ="" disabled="disabled"/>
            		</div>
            		<div class="form-group">
            		...
            		<div class="form-group">
            			...
            			<input type="text" style="margin-left: 68px;" value="" disabled="disabled"/>
            		</div>
            	 ...
            	 <div class="col-md-6">
            		...
            		<div class="form-group">
            			...
            			<input type="text" style="margin-left: 110px;" value="" disabled="disabled" />
            		</div>
            		<div class="form-group">
            			<label class="control-label">Salary</label>
            			<input type="text" style="margin-left: 157px;" value=""  disabled="disabled"/>
            		</div>
            		<div class="form-group">
            		...
            		<div class="form-group">
            			...
            			<input type="text" style="margin-left: 73px;" value="" disabled="disabled" />
            		</div>
            	</div>
            	</div>
            	</div>
